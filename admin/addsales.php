                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add to Existing Sales</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-12">Select Transaction to add</label>
...
<script>
    ...
    $("#saleTransaction").change(function() {
        ...
        $.ajax({
            type: "POST",
            url: "ajaxscripts/tables/addNewSalestable.php",
            beforeSend: function() {
                $.blockUI({
