    ...
    <div class="col-12">
        ...
        <form class="faq-search-input mb-1">
            <div class="input-group input-group-merge">
                ...
                <input type="text" id="addProduct" class="form-control" autocomplete="off" placeholder="Search product name" />
            </div>
        </form>
...
<script>
    ...
    function doneTyping() {
        ...
        var product_search = $("#addProduct").val();
