    ...
    <form class="form form-horizontal">
          <div class="row">
            ...
            <div class="mb-1 col-md-4">
              ...
              placeholder="Amount Paid" onkeypress="return isNumberKey(event)"/>
            </div>
            <div class="mb-1 col-md-4">
          ...
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <select id="expcategory" class="form-select">
                <option></option>
                <?php
                $getexpcategory = $mysqli->query("select * from expcategories where status IS NULL");
                while ($resexpcategory = $getexpcategory->fetch_assoc()) { ?>
                    <option value="<?php echo $resexpcategory['expcatid'] ?>"><?php echo $resexpcategory['categoryname'] ?></option>
                <?php }
                ?>
              </select>
            </div>
