          ...
          $getsaledetails = $mysqli->query("SELECT DISTINCT(SUBSTR(`datetime`,1,10)) as date FROM `sales` 
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="heading<?php echo $ressalesdetails['date']; ?>">
                ...
                data-bs-target="#accordion<?php echo $ressalesdetails['date']; ?>" aria-expanded="false" 
                aria-controls="accordion<?php echo $ressalesdetails['date']; ?>">
                  <?php echo $date = $ressalesdetails['date']; ?>
                </button>
              </h2>
              <div id="accordion<?php echo $ressalesdetails['date']; ?>" class="accordion-collapse collapse" 
              aria-labelledby="heading<?php echo $ressalesdetails['date']; ?>" 
