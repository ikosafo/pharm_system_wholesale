          ...
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="barcode" name="barcode" class="form-control" 
                placeholder="Barcode" autocomplete="off" value="<?php echo $resdetails['barcode']; ?>"/>
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="productname">Product Name</label>
              <input type="text" id="productname" name="productname" class="form-control" 
                placeholder="Product Name" value="<?php echo $resdetails['productname']; ?>"/>
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="quantitysale">Quantity (For Sale)</label>
              <input type="text" id="quantitysale" name="quantitysale" class="form-control" 
                        onkeypress="return isNumber(event)" 
                        placeholder="Quantity (For Sale)"  value="<?php echo $resdetails['quantitysale']; ?>"/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-4">
              <label class="form-label" for="quantitystock">Quantity (In Stock)</label>
              <input type="text" id="quantitystock" name="quantitystock" class="form-control" 
                        onkeypress="return isNumber(event)" 
                        placeholder="Quantity (In Stock)" value="<?php echo $resdetails['quantitystock']; ?>" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="stockthreshold">Low stock threshold</label>
              <input type="text" id="stockthreshold" name="stockthreshold" 
                        onkeypress="return isNumber(event)" 
                        class="form-control" 
                        placeholder="Low stock threshold"  value="<?php echo $resdetails['stockthreshold']; ?>"s/>
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="sku">SKU (Stock Keeping Unit)</label>
              <input type="text" id="sku" name="sku" class="form-control" 
                    placeholder="SKU" value="<?php echo $resdetails['sku']; ?>" />
            </div>
            <div class="mb-1 col-md-4">
              ...
              <select id="supplier" name="supplier" class="form-select">
                <option></option>
                <?php 
                    $supplierid = $resdetails['supplier'];
                    $getsupplier = $mysqli->query("select * from supplier where status IS NULL");
                    while ($ressupplier = $getsupplier->fetch_assoc()) { ?>
                    <option value="<?php echo $ressupplier['supid'] ?>" <?php if (@$ressupplier['supid'] == $supplierid) echo "selected" ?>>
                        <?php echo $ressupplier['fullname'].' - '.$ressupplier['companyname'] ?>
                    </option>
                    <?php }
                    ?>
                    <option <?php if (@$resdetails['supplier'] == "0") echo "Selected" ?>>Others</option>
              </select>
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="expirydate">Expiry Date</label>
              <input type="text" id="expirydate" name="expirydate" class="form-control" 
                        placeholder="Expiry Date" value="<?php echo $resdetails['expirydate']; ?>" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="isbn">UPC/EAN/ISBN</label>
              <input type="text" id="isbn" name="isbn" class="form-control" 
              placeholder="UPC/EAN/ISBN" value="<?php echo $resdetails['isbn']; ?>"/>
            </div>
        ...
        <form>
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation1spec" name="variation1spec" class="form-control" 
                    placeholder="Specify Variation 1" value="<?php echo $resdetails['variation1spec']; ?>"/>
            </div>
          ...
          <div class="row">
             <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation2spec" name="variation2spec" class="form-control" 
                    placeholder="Specify Variation 2" value="<?php echo $resdetails['variation2spec']; ?>"/>
            </div>
          ...
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation3spec" name="variation3spec" class="form-control" 
                    placeholder="Specify Variation 3" value="<?php echo $resdetails['variation3spec']; ?>" />
            </div>
          </div>
        ...
        <form>
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="costprice" onkeypress="return isNumberKey(event)"
              name="costprice" class="form-control" value="<?php echo $resdetails['costprice']; ?>"
              placeholder="Cost Price" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="sellingprice">Selling Price (Retail)</label>
              <input type="text" id="sellingprice" onkeypress="return isNumberKey(event)"
              name="sellingprice" class="form-control" value="<?php echo $resdetails['sellingprice']; ?>"
              placeholder="Selling Price" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="sellingpricewhole">Selling Price (Wholesale)</label>
              <input type="text" id="sellingpricewhole" onkeypress="return isNumberKey(event)"
              name="sellingpricewhole" class="form-control" value="<?php echo $resdetails['sellingpricewhole']; ?>"
              placeholder="Selling Price (Wholesale)" />
            </div>
            ...
            .each(function () {
                $(this).validate({
                    rules: {            
                      ...
                      quantitysale: { required: !0 },
                      quantitystock: { required: !0 },
                      stockthreshold: { required: !0 },
                      supplier: { required: !0 },
                      category: { required: !0 },
                      subcategory: { required: !0 },
                      variation1: { required: !0 },
                      variation1spec: { required: !0 },
