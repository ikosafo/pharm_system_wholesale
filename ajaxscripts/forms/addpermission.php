            ...
            <div class="col-12">
                ...
                <select class="form-select" id="permissions" multiple>
                    <optgroup label="Products">
                        ...
                        <option value="Categories, Subcategories and Variations">Categories, Subcategories and Variations</option>
                    </optgroup>
                    ...
                    <optgroup label="Expenses">
                        <option value="Categories, Add and View Expenses">Categories, Add and View Expenses</option>
