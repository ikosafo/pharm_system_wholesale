<?php include ('../../config.php'); ?>
    ...
    <form class="form form-horizontal">
        ...
        <div id="error_loc"></div>
            ...
            <div class="mb-1 col-md-4">
                <label class="form-label" for="quantitysale">Quantity (For Sale) <span style="color:red">*</span></label>
                <input type="text" id="quantitysale" class="form-control" 
                        onkeypress="return isNumber(event)" 
                        placeholder="Quantity (For Sale)" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="quantitystock">Quantity (In Stock) <span style="color:red">*</span></label>
              <input type="text" id="quantitystock" class="form-control" 
                        onkeypress="return isNumber(event)" 
        ...
        <div class="row">
            ...
            <div class="mb-1 col-md-4">
              ...
              name="costprice" class="form-control" placeholder="Cost Price" />
            </div>
        ...
        <div class="row">
           ...
           <div class="mb-1 col-md-4">
             <label class="form-label" for="sellingprice">Selling Price (Retail) <span style="color:red">*</span></label>
             <input type="text" id="sellingprice" onkeypress="return isNumberKey(event)"
             name="sellingprice" class="form-control" placeholder="Selling Price" />
           </div>
           <div class="mb-1 col-md-4">
             ...
             name="sellingpricewhole" class="form-control" placeholder="Selling Price (Wholesale)" />
           </div>
