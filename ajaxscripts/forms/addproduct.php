        ...
        <form autocomplete="off">
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="barcode" name="barcode" class="form-control" placeholder="Barcode" autocomplete="off" />
            </div>
            <div class="mb-1 col-md-4">
            ...
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="quantitysale" name="quantitysale" class="form-control" onkeypress="return isNumber(event)" placeholder="Quantity (For Sale)" />
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-4">
            ...
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="stockthreshold" name="stockthreshold" onkeypress="return isNumber(event)" class="form-control" placeholder="Low stock threshold" />
            </div>
            <div class="mb-1 col-md-4">
            ...
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="expirydate" name="expirydate" class="form-control" placeholder="Expiry Date" />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="isbn">UPC/EAN/ISBN</label>
              <input type="text" id="isbn" name="isbn" class="form-control" placeholder="UPC/EAN/ISBN" />
            </div>
        ...
        <form autocomplete="off">
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <select id="variation1" name="variation1" class="form-select">
                ...
                while ($resvariation1 = $getvariation1->fetch_assoc()) { ?>
                  <option value="<?php echo $resvariation1['varid'] ?>">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation1spec" name="variation1spec" class="form-control" placeholder="Specify Variation 1" />
            </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <select id="variation2" name="variation2" class="form-select">
                ...
                while ($resvariation2 = $getvariation2->fetch_assoc()) { ?>
                  <option value="<?php echo $resvariation2['varid'] ?>">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation2spec" name="variation2spec" class="form-control" placeholder="Specify Variation 2" />
            </div>
          ...
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <select id="variation3" name="variation3" class="form-select">
                ...
                while ($resvariation3 = $getvariation3->fetch_assoc()) { ?>
                  <option value="<?php echo $resvariation3['varid'] ?>">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="variation3spec" name="variation3spec" class="form-control" placeholder="Specify Variation 3" />
            </div>
          </div>
...
<script>
  ...
  $("#category").change(function() {
    ...
    if (category != "") {
      $.ajax({
        url: "ajaxscripts/forms/getsubcategory.php",
        data: {
          category: category
        },
        type: 'POST',
